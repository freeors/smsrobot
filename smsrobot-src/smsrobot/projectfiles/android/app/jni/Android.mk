...
LOCAL_SRC_FILES := \
	$(subst $(LOCAL_PATH)/,, \
	$(wildcard $(LOCAL_PATH)/smsrobot/*.c) \
	$(wildcard $(LOCAL_PATH)/smsrobot/*.cc) \
	$(wildcard $(LOCAL_PATH)/smsrobot/*.cpp) \
	$(wildcard $(LOCAL_PATH)/smsrobot/gui/dialogs/*.c) \
	$(wildcard $(LOCAL_PATH)/smsrobot/gui/dialogs/*.cpp) \
